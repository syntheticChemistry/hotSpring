...
pub use core::{
    ...
    GAMMA_TOLERANCE, GLOWPLUG_F32_SAXPY_MAX_ABS, GPU_VS_CPU_F64, INCOMPLETE_GAMMA_TOLERANCE,
    ITERATIVE_F64, LAGUERRE_TOLERANCE, LU_TOLERANCE, NELDER_MEAD_FTOL, NELDER_MEAD_TOLERANCE,
    NORMAL_CDF_TOLERANCE, NORMAL_PPF_TOLERANCE, PRECISION_MATRIX_DEFAULT_ABS,
    PRECISION_MATRIX_DF64_ABS, PRECISION_MATRIX_FP32_ABS, PRECISION_MATRIX_FP64_DF128_ABS,
    QR_TOLERANCE, RK45_ATOL, RK45_RTOL, RK45_TOLERANCE, SOBOL_TOLERANCE,
    SOVEREIGN_ROUNTRIP_GPU_PARITY_ABS, SOVEREIGN_ROUNTRIP_RAW_VS_EXPECTED_ABS, SVD_TOLERANCE,
    TRIDIAG_TOLERANCE,
};
...
pub use lattice::{
    ...
    ADAPTIVE_DT_MAX,
    ADAPTIVE_DT_MIN,
    ADAPTIVE_HIGH_ACCEPTANCE,
    ADAPTIVE_LOW_ACCEPTANCE,
    ADAPTIVE_NMD_MAX,
    ADAPTIVE_NMD_MIN,
    ADAPTIVE_TARGET_ACCEPTANCE,
    ...
    ANDERSON_3D_METALLIC_R_MIN,
    ANDERSON_3D_POISSON_R_MEAN_DEVIATION,
    ANDERSON_EIGENVALUE_ABS,
    BETA_SCAN_ACCEPTANCE_MIN,
    BETA_SCAN_CONFINED_POLYAKOV_MAX,
    BETA_SCAN_GRID_TOLERANCE,
    BETA_SCAN_PLAQUETTE_MONOTONICITY,
    BETA_SCAN_PYTHON_RUST_PLAQUETTE_PARITY,
    BETA_SCAN_SCALING_PARITY,
    BETA6_PLAQUETTE_REF,
    BETA6_PLAQUETTE_TOLERANCE,
    CG_BACKOFF_CAP,
    DYNAMICAL_CG_MAX_ITER,
    DYNAMICAL_CG_TOLERANCE,
    DYNAMICAL_CONFINED_POLYAKOV_MAX,
    DYNAMICAL_FERMION_ACTION_MIN,
    ...
    LATTICE_PLAQUETTE_PHYSICAL_MIN,
    ...
    POISSON_MEAN_R,
    // RHMC self-tuning calibrator
    RHMC_APPROX_ERROR_THRESHOLD,
    RHMC_CG_TOL_FORCE,
    RHMC_CG_TOL_METROPOLIS,
    RHMC_CONSISTENCY_THRESHOLD,
    RHMC_MAX_POLES,
    RHMC_POLE_INCREMENT,
    RHMC_POWER_ITERATION_COUNT,
    RHMC_SPECTRAL_REPROBE_INTERVAL,
    RHMC_SPECTRAL_SAFETY_HIGH,
    RHMC_SPECTRAL_SAFETY_LOW,
    SPECTRAL_GERSHGORIN_SLACK,
    SPECTRAL_GERSHGORIN_SLACK_LATTICE,
    SPECTRAL_LYAPUNOV_KW_THEORY_REL,
    SPECTRAL_SPMV_MAX_ABS,
    SPMV_GPU_VS_CPU_ABS,
    SPMV_IDENTITY_ABS,
    SPMV_ITERATED_ABS,
...
pub use md::{
    BCS_CHEMICAL_POTENTIAL_REL, BCS_PARTICLE_NUMBER_ABS, BRAIN_ENERGY_WINDOW,
    BRAIN_EQUILIBRIUM_THRESHOLD, BRAIN_MIN_TRAINING_SAMPLES, BRAIN_THROUGHPUT_WINDOW,
    CELLLIST_FORCE_DIAG_THRESHOLD, CELLLIST_MIN_CELLS_PER_DIM, CELLLIST_NETFORCE_TOLERANCE,
    CELLLIST_PE_TOLERANCE, CELLLIST_REBUILD_INTERVAL, DALIGAULT_FIT_RMSE,
    DALIGAULT_FIT_VS_CALIBRATION, DEFAULT_VELOCITY_SEED, ENERGY_DRIFT_PCT,
    ESN_SPECTRAL_RADIUS_NEGLIGIBLE, GPU_EIGENSOLVE_REL, GPU_EIGENVECTOR_ORTHO,
    GPU_NATIVE_VS_SOFTWARE_F64, HFB_RUST_VS_PYTHON_REL, MD_ABSOLUTE_FLOOR, MD_BOX_MULLER_FLOOR,
    MD_ENERGY_FLOOR, MD_EQUILIBRIUM_FORCE_ABS, MD_FORCE_MAGNITUDE_FLOOR, MD_FORCE_TOLERANCE,
    MD_TARGET_TEMPERATURE_GUARD, MD_TEMPERATURE_FLOOR, MD_WORKGROUP_SIZE, NEWTON_3RD_LAW_ABS,
    PARITY_D_STAR_REL, PARITY_ENERGY_DIFF, PARITY_T_DIFF, PPPM_MADELUNG_REL,
    PPPM_MULTI_PARTICLE_NET_FORCE, PPPM_NEWTON_3RD_ABS, PROGRESS_REPORT_INTERVAL,
    RDF_TAIL_TOLERANCE, THERMOSTAT_INTERVAL, TITAN_RECEIVE_TIMEOUT_SECS,
    ...
    TRANSPORT_T_STABILITY, TRANSPORT_VACF_CPU_GPU_PARITY_REL, TRANSPORT_VISCOSITY_VS_SARKAS,
    VERLET_MAX_NEIGHBORS, VERLET_MIN_PARTICLES, VERLET_SKIN_FRACTION,
};
...
pub use physics::{
    BCS_DENSITY_SKIP, BGK_MASS_CONSERVATION_ABS, BROYDEN_HISTORY, BROYDEN_WARMUP,
    COMPOSITION_PLAQUETTE_PARITY_ABS, COMPOSITION_SEMF_PARITY_REL, COULOMB_R_MIN,
    DEFORMATION_GUESS_GENERIC, DEFORMATION_GUESS_SD, DEFORMATION_GUESS_WEAK,
    DEFORMED_COULOMB_R_MIN, DENSITY_FLOOR, DIELECTRIC_COMPLETED_DSF_POSITIVE_FRACTION_MIN,
    DIELECTRIC_DEBYE_SCREENING_REL, DIELECTRIC_DRUDE_CONDUCTIVITY_REL,
    DIELECTRIC_DSF_MAGNITUDE_FLOOR, DIELECTRIC_DSF_POSITIVE_FRACTION_MIN,
    DIELECTRIC_DSF_RELATIVE_NOISE_FLOOR, DIELECTRIC_F_SUM_GPU_CPU_REL,
    DIELECTRIC_HIGH_FREQ_LIMIT_ABS, DIELECTRIC_PLASMA_DISPERSION_W0_ABS, DIVISION_GUARD,
...
mod tests {
    ...
    fn all_tolerances_are_positive() {
        let tols = [
            ...
            TRANSPORT_VACF_CPU_GPU_PARITY_REL,
            PARITY_D_STAR_REL,
            PARITY_T_DIFF,
            PARITY_ENERGY_DIFF,
            DIELECTRIC_F_SUM_GPU_CPU_REL,
            DIELECTRIC_HIGH_FREQ_LIMIT_ABS,
            DIELECTRIC_PLASMA_DISPERSION_W0_ABS,
            DIELECTRIC_DEBYE_SCREENING_REL,
            DIELECTRIC_DRUDE_CONDUCTIVITY_REL,
            DIELECTRIC_DSF_RELATIVE_NOISE_FLOOR,
            DIELECTRIC_DSF_MAGNITUDE_FLOOR,
            DIELECTRIC_DSF_POSITIVE_FRACTION_MIN,
            DIELECTRIC_COMPLETED_DSF_POSITIVE_FRACTION_MIN,
            LATTICE_COLD_PLAQUETTE_ABS,
            LATTICE_COLD_ACTION_ABS,
            LATTICE_HMC_ACCEPTANCE_MIN,
            LATTICE_CG_RESIDUAL,
            ...
            PRECISION_MATRIX_DEFAULT_ABS,
            PRECISION_MATRIX_DF64_ABS,
            PRECISION_MATRIX_FP32_ABS,
            PRECISION_MATRIX_FP64_DF128_ABS,
            SOVEREIGN_ROUNTRIP_GPU_PARITY_ABS,
            SOVEREIGN_ROUNTRIP_RAW_VS_EXPECTED_ABS,
            NPU_F32_PARITY,
            ...
            U1_HIGGS_CONDENSATE_BOUNDARY,
            U1_CONDENSATE_MONOTONICITY,
            // GPU streaming / dynamical fermion parity
            GPU_CG_ACTION_PARITY,
            GPU_DYN_STREAMING_PLAQUETTE_PARITY,
            GPU_FERMION_FORCE_PARITY,
            GPU_STREAMING_PLAQUETTE_PARITY,
            ...
            NMP_SIGMA_THRESHOLD,
            FPEOS_GRID_POINT_REL,
            FPEOS_HE_TO_H_PRESSURE_RATIO_MAX,
