...
pub use basic::{
    test_buffer_read_probe, test_write_constant, test_write_constant_inner, test_write_thread_id,
};
pub use f64_ops::{
    ...
    test_f64_literal_write, test_num_workgroups, test_nwg_idx_debug, test_uniform_read,
};
