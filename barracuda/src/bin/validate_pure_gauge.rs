...
fn main() {
    ...
    // Sovereign GPU compile validation was previously done via coral_gpu (excised).
    // Shader compilation now routes through coralReef IPC (shader.compile.wgsl).
    // See validate_sovereign_compile.rs for the modern toadStool+coralReef pipeline.
