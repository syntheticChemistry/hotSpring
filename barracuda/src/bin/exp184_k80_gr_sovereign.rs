...
use k80_gr_sovereign::{
    BOOT0, FECS_BASE, FECS_BOOTVEC, FECS_CMD_INIT, FECS_CPUCTL, FECS_DMEM_FW_OFFSET, FECS_DMEMC,
    FECS_DMEMD, FECS_HWCFG, FECS_MB0, FECS_MB1, FECS_PC, FECS_RESET, FECS_SCTL, GPC0_BOOT0,
    GPC1_BOOT0, GPCCS_BASE, GPCCS_BOOTVEC, GPCCS_CPUCTL, GPCCS_DMEM_FW_OFFSET, GPCCS_DMEMC,
    GPCCS_DMEMD, GPCCS_HWCFG, GPCCS_MB0, GPCCS_MB1, GPCCS_PC, GR_CTX_SIZE, GR_READY,
