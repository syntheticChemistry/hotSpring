...
fn main() {
    ...
    println!("── Statistics: Normal Distribution ──");
    {
        ...
        let cdf_tests = vec![
            (0.0, 0.5, "Φ(0) = 0.5"),
            (1.96, 0.975_002_104_9, "Φ(1.96) ≈ 0.975"),
            (-1.96, 0.024_997_895_1, "Φ(-1.96) ≈ 0.025"),
            (3.0, 0.998_650_102_0, "Φ(3) ≈ 0.9987"),
        ];
        ...
        let ppf_tests = vec![
            (0.5, 0.0, "Φ⁻¹(0.5) = 0"),
            (0.975, 1.959_964, "Φ⁻¹(0.975) ≈ 1.96"),
            (0.025, -1.959_964, "Φ⁻¹(0.025) ≈ -1.96"),
            (0.999, 3.090_232, "Φ⁻¹(0.999) ≈ 3.09"),
        ];
