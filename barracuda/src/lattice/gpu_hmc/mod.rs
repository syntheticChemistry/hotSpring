...
use barracuda::ops::lattice::absorbed_shaders::WGSL_SU3_MATH_F64 as WGSL_SU3_MATH_F64_UPSTREAM;
...
/// WGSL shader: SU(3) gauge force (staple + traceless anti-Hermitian projection, WG128).
pub const WGSL_GAUGE_FORCE: &str = include_str!("../shaders/su3_gauge_force_f64.wgsl");

/// WGSL shader: DF64 gauge force — staple computation on FP32 cores (WG128).
