...
**Hardware (biomeGate):** Titan V #1 (0000:02:00.0), Titan V #2 (0000:49:00.0), RTX 5060 (GB206) (0000:21:00.0). K80 retired (destroyed Exp 199).
**Historical BDFs:** Some capture filenames reference earlier BDF assignments (0000:03:00.0, 0000:4b:00.0) from pre-PCIe topology changes.
...
Generated by `compare_snapshots.py` (fossilized — script archived, results preserved):
