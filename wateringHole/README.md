...
| 2026-05-25 | `HOTSPRING_REAGENT_PIPELINE_EVOLVED_EXP222_MAY25_2026.md` | ✅ | **Exp 222 Reagent Capture Pipeline Evolved:** Dual GPU compute validated (RTX 5060 VectorAdd + Titan V HBM2 PASS). PMU firmware determinism proven (MD5 identical May 11 vs May 25). SBR cold reset via upstream bridge. PMC_ENABLE writes work post-SBR. FECS powers up. Sovereign boot chain mapped: SBR→PMC→WPR→ACR. 27 RPCs. nvidia-470 VM live. Remaining blocker: WPR+ACR mailbox protocol. |
