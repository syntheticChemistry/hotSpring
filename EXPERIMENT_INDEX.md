...
| **CAZyme FEL** (Exp 220) | ✅ Phase 0.7 | **Biomolecular MD evolution — CAZyme conformational energy landscapes.** GROMACS 2026.0 + PLUMED 2.9.2 + CHARMM36. **Phase 0.4:** Alanine dipeptide WTMetaD validated (C7eq/C7ax, ΔF=5.57 kJ/mol). **Phase 0.5:** Free xylose puckering FEL — Cremer-Pople theta CV, three basins (two chairs + boat), barriers 38-53 kJ/mol. **Phase 0.6:** pseudoSpore v0.6.0 (had lyxose error + M3 not post-processed). **Phase 0.7:** Alistaire review corrections — rebuilt M2 from crystal xylose, completed M3 sum_hills, acceptance test DONE (enzyme lowers all barriers 1-5 kJ/mol). Sovereign FEL parity proven (Tier 0→1→2: MATCH <1 kJ/mol). pseudoSpore v0.7.0. Next: Cremer-Pople convention resolution, Phase 1 barraCuda bonded FF shaders. See `experiments/220_CAZYME_CONFORMATIONAL_ENERGY_LANDSCAPES.md` |
