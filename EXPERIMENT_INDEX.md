...
| **CAZyme FEL** (Exp 220) | 🔄 Phase 0.6 ✅ | **Biomolecular MD evolution — CAZyme conformational energy landscapes.** GROMACS 2026.0 + PLUMED 2.9.2 + CHARMM36. **Phase 0.4:** Alanine dipeptide WTMetaD validated (C7eq/C7ax, ΔF=5.57 kJ/mol). **Phase 0.5:** Free xylose puckering FEL — Cremer-Pople theta CV, three basins (two chairs + boat), barriers 42-54 kJ/mol. **Phase 0.6:** pseudoSpore v0.6.0 handoff packaged + sovereign FEL parity proven (Tier 0 GROMACS → Tier 1 Python → Tier 2 Rust: all MATCH <1 kJ/mol; Tier 1 vs Tier 2: 0.00 kJ/mol). Live sweetGrass braid. lithoSpore promotion staged. Next: Phase 0.7 (enzyme-bound FEL analysis after Alistaire convention confirmation). Phase 1: barraCuda bonded FF shaders. See `experiments/220_CAZYME_CONFORMATIONAL_ENERGY_LANDSCAPES.md` |
