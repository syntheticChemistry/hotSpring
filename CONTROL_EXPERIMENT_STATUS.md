...
> **Note (March 30, 2026):** For current status, see the [root README](README.md), [`EXPERIMENT_INDEX.md`](EXPERIMENT_INDEX.md), and [`specs/GPU_CRACKING_GAP_TRACKER.md`](specs/GPU_CRACKING_GAP_TRACKER.md). **NVIDIA GPFIFO pipeline OPERATIONAL on RTX 3090. AMD scratch/local memory OPERATIONAL on RX 6950 XT (Exp 124). 124 experiments. 7/8 HW parity tests, 1672 coral unit tests.** The body of this document is a fossil record from March 16 — retained for provenance.
