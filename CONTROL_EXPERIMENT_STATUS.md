...
**Date**: 2026-02-21 (L1+L2 complete, GPU MD Phase C+D+E+F complete — paper-parity long run 9/9, BarraCUDA pipeline 26/26, crate v0.6.0)  
...
- [`barracuda/CHANGELOG.md`](barracuda/CHANGELOG.md) — Crate version history (v0.6.0)
