...
> **Note (March 22, 2026):** For current sprint status, see [Exp 075](experiments/075_DEEP_DEBT_CROSS_VENDOR_DISPATCH.md) (deep-debt burndown + cross-vendor dispatch), the [deep-debt handoff](wateringHole/handoffs/HOTSPRING_DEEP_DEBT_CROSS_VENDOR_HANDOFF_MAR2026.md), and the [root README](README.md). pkexec-free pipeline validated. RTX 5060 dual-use (display + compute) proven. PMU cracking tooling hardened (BusyGuard, try_read_u32, OracleError). 75 experiments.
