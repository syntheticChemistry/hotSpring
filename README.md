...
| **DRM Dispatch Evolution** (Exp 072) | ✅ Phase 2 | Dual-track: DRM + sovereign VFIO. **AMD GCN5 E2E PASSED** — WGSL → coral-reef → coral-driver PM4 → MI50 → 64/64 readback verified. 7 bugs found/fixed (VOP3 opcode translation, wave64, GLOBAL segment, SGPR mapping, ACQUIRE_MEM, s_waitcnt). **Naga bypass validated end-to-end.** NVIDIA PMU-blocked on Titan V. K80 incoming. |
