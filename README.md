...
*219 experiments, 700 (cylinder) / 596 (barracuda default) / 1,045 (barracuda-local) lib tests, 167 binaries, 128 WGSL shaders, ~$0.30 total science cost.
...
firmware-dependent (Exp 217). **Catalyst Driver Pattern** (Exp 219) — proprietary
driver as chemical catalyst: load → capture BAR0 golden state → remove → replay
without catalyst. 3-layer preservation (recipe TOML / frozen .ko / product JSON).
24 RPC methods. `sovereign.catalyst_diff`, `sovereign.catalyst_boot` RPCs.
