...
*226 experiments, 710 (cylinder) / 596 (barracuda default) / 1,045 (barracuda-local) lib tests, 167 binaries, 129 WGSL shaders, ~$0.30 total science cost.
