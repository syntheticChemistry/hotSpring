...
| **DRM Dispatch Evolution** (Exp 072) | 🔄 Active | Dual-track: DRM + sovereign VFIO. **AMD NOP dispatch PASSED** — PM4 `s_endpgm` → fence on MI50/GCN5. NVIDIA new UAPI coded, PMU-blocked on Titan V. K80 incoming. **Naga bypass**: WGSL → coral-reef → native ISA → DRM. GCN5 backend for MI50 next. |
