...
> 165 binaries, 128 WGSL shaders. For current absorption status see `barracuda/ABSORPTION_MANIFEST.md`.
...
- 22 papers reproduced, 985 lib tests, 63/63 validation suites, ~$0.30 total compute cost
