...
> **HISTORICAL** — Snapshot from February 25, 2026 (v0.6.15). Current state: v0.6.32, 964 tests,
> 164 binaries, 128 WGSL shaders. For current absorption status see `barracuda/ABSORPTION_MANIFEST.md`.
...
- 22 papers reproduced, 664 tests (629 lib + 31 integration + 4 doc), 62/62 validation suites, ~$0.20 total compute cost
