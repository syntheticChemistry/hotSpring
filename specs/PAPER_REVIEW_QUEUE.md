...
> Current state: v0.6.32, 627 / 1,045 lib tests (IPC-first default / barracuda-local), 155 binaries, 154 WGSL shaders. Paper reproduction
...
**Crate**: hotspring-barracuda v0.6.32 — 627 / 1,045 lib tests (IPC-first default / barracuda-local), 155 binaries, 154+ WGSL shaders
