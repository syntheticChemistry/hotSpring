...
| L3: PMC enable | PASS (Exp 123) | BLOCKED | UNTESTED |
| L4-L6: PFIFO/PBDMA | UNTESTED | BLOCKED | UNTESTED |
| L7: SEC2/ACR | N/A (Kepler: no ACR) | N/A | N/A |
| L8: FECS boot | UNTESTED (PIO direct — no HS barrier) | BLOCKED | UNTESTED |
| L9-L11: Dispatch | UNTESTED | BLOCKED | UNTESTED |
| Compile | PASS (SM35) | PASS (SM35) | PASS (SM35) |
...
| coral-ember | current | reset_method race fix, privileged sysfs writes, journal/swap tracking | GPU lifecycle management stable |
| coral-glowplug | current | Dynamic livepatch control in `coralctl warm-fecs`, boot sovereignty | Device broker operational |
