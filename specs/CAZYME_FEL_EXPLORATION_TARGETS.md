...
- [`pseudoSpore_hotSpring-CompChem-GuideStone_v1.6.1/`](../pseudoSpore_hotSpring-CompChem-GuideStone_v1.6.1/) — validated methodology (8 modules, unified liveSpore.json)
...
- [`TRANSLATE.md`](../pseudoSpore_hotSpring-CompChem-GuideStone_v1.6.1/TRANSLATE.md) — CV conventions
